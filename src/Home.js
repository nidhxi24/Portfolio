                ...
                <div className="about">
                    <div className="intro">
                        <div className="name">
                            ...
                            {/* A Frontend Developer specialiezed in React */}
                    </div>
                    <div className="about-button">
                        <div className="about-button-icon">
                            <div
                                ...
                                onClick={() =>
                                    window.open("https://github.com/nidhxi24", "_blank")
                                }
                            >
                                <svg
                        ...
                        <i class='bx bx-cloud-download' style={{fontSize: "1.5rem"}}></i>
                            {/* <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
                            ...
                            <span style={{marginLeft: "0.4rem"}}>Download Resume</span>
                        </button>
                    </div>
                </div>
